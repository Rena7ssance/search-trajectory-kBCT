...
\begin{figure}[!htp]
  ...
  \bicaption[fig:login-interface]{用户登录界面与用户地图界面设计}{用户登录界面与用户地图界面设计}{Fig}{User login and function interface design}
\end{figure}
...
%  \bicaption[fig:search-history-interface]{查询界面与历史轨迹显示界面设计}{查询界面与历史轨迹显示界面设计}{Fig}{Search and history trajectories interface design}
%\end{figure}
