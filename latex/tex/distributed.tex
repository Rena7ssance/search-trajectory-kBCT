...
\begin{figure}[!htp]
  ...
  \bicaption[fig:4-3]{这里将出现在插图索引中}{\emph{TS}算法结果样例}{Fig}{An illustration of Trajectory Simplification Algorithm}
\end{figure}
...
\begin{figure}[!htp]
  ...
  \bicaption[fig:4-4]{这里将出现在插图索引中}{Spark分布式相似轨迹查询}{Fig}{Spark distributed search similar trajectories}
\end{figure}
